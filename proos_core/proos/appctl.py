...
def candidates(client, project, area_id: str) -> list:
    ...
    def _add(eid, is_display, inp):
        ...
        # NOTE: no fallback app list. A guessed list offers apps that aren't
        # installed and hides ones that are. Android boxes publish their real
        # list once learned in Pro (room -> device -> Learn apps).
        out.append(rec_out)
