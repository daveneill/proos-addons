...
class MaClient:
    ...
    def provider_auth(self, provider_domain: str, session_id: str, on_auth_url,
        ...
        """Run a provider OAuth 'auth' action and drive it to completion on ONE
        connection (MA ties the flow to a single socket). Confirmed MA behaviour:
