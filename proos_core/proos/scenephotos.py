...
#
# A HOSTED URL IS NOT A READING — LOOK AT IT LARGE BEFORE YOU CHANGE ONE.
# 19 Aug 2026. Dave's homeowner Scenes page showed his "Work" scene wearing a
# photograph nobody would call restful. Nothing had matched wrongly — the
# picture BEHIND a URL that had sat here for weeks had changed. Rendered all
# nine in a browser; three no longer showed what their key says:
#   relax → a barista holding an espresso portafilter. Not "relax / cosy", and
#           relax is the catch-all, so this was every unmatched scene's photo.
#   work  → a corridor through a modern open-plan interior. No desk in it.
#   party → a plated restaurant dish with a glass of wine. That is dinner.
#
# AND A SECOND LESSON, WORSE THAN THE FIRST. I first recorded the relax photo
# here as "a man handling a rifle". It is a barista. I read a 150-pixel
# thumbnail and named a weapon — the same shape of mistake as the one I was
# fixing, one level up. LOOK AT THE PICTURE AT FULL SIZE. A glance is not a
# reading, and a bench cannot check this one for you.
CATALOG = [
