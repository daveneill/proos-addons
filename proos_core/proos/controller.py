...
COMMISSIONING: dict = {
    ...
    "Living Room": {
        ...
        # The AVR plan that lived here named media_player.living_room_av_receiver
        # and media_player.living_room_shield_tv. Home Assistant reports BOTH as
        # ENTITY_NOT_FOUND -- they have never existed in this house. It took
        # precedence over the committed record via _audio_plan(), so the phantom
        # became the broadcast audio witness and Live TV could never verify.
        # Removed: the room's AV switch is committed in Pro and read from the record.
