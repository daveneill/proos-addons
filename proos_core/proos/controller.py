...
# is config data, not logic -- shaped exactly as the add-on config / installer
# UI will provide it, so moving it out of code later changes nothing here.
#
# Keyed: area -> source_eid (or "__broadcast__") -> binding dict. A binding may
# carry any of: "route" ({c4_entity,c4_source} | {tv_remote,hdmi_code}), "wake"
# ({domain,service,entity}), "reachability_sensor".
#
# Family Room: Control4 owns the discrete switch (the Frame ignores HA's codes);
# C4's 'source' echo is NOT trusted -- verification stays on the witnesses.
COMMISSIONING: dict = {
    "Family Room": {
        "media_player.family_room_apple_tv": {
            "route": {"c4_entity": "media_player.family_room_2", "c4_source": "Apple TV"},
            "wake": {"domain": "media_player", "service": "turn_on",
                     "entity": "media_player.family_room_apple_tv"},
        },
        "media_player.family_room_shield_tv": {
            "route": {"c4_entity": "media_player.family_room_2", "c4_source": "Shield TV"},
        },
        "__broadcast__": {
            "route": {"c4_entity": "media_player.family_room_2", "c4_source": "Digital TV"},
        },
    },
}
