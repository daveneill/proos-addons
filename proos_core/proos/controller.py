...
class RoomController:
    ...
    def _committed_cluster(self):
        ...
        try:
            ...
            # THE RECORD IS THE TRUTH (4 Aug 2026). This used to be a raw
            # `areas.get(self.area)` — but self.area is a NAME and the
            # project is keyed by area_id, so it found NOTHING for every
            # room, always, and every committed room silently ran on
            # discovery. One resolver, benched.
            rec = project.committed_record(project.load(), self.area)
            if rec:
    ...
    def refresh(self):
        ...
        if cluster is None:
            ...
            try:
                ...
                _rec = _p._resolve_rec(_p.load(), self.area) or {}
    ...
    def _script_entity_for(self, a) -> str | None:
        ...
        try:
            ...
            area_slug = (generator.room_slug(self.cluster) if self.cluster
                         else generator._slug(self.area))
