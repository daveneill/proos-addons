...
class ToolRunner:
    ...
    def t_scene_create(self, args):
        ...
        for st in states:
            ...
            entities[e] = ent
        if not entities:
            return {"error": "no valid entities — capture lights/climate/covers (not media players)"}
...
def _system_prompt(user: dict, home_name: str) -> str:
    ...
    return (
        ...
        "start playback: use music_play; TV/AV power is a room activity). ALWAYS follow the "
