...
#
# A HOSTED URL IS NOT A READING — LOOK AT IT BEFORE YOU WRITE IT HERE.
# 19 Aug 2026: every photo in this file was rendered in a browser and looked
# at, after Dave's homeowner Scenes page served a picture of a man handling a
# rifle. The URL had not changed; the PICTURE BEHIND IT had, months after it
# was chosen, and nothing in the product could tell. Found and replaced:
#   garage        → that same rifle photo
#   office/study  → a collage of three empty rooms, no desk in it
#   outdoor       → a house exterior, not an outdoor living space
#   nursery       → an armchair and a shelf, nothing of a child's room
...
# No bench can look at a photograph. A person has to, and that is the job.
ROOM_KINDS = [
