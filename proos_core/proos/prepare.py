...
PREPARE_FACTS = {
    "samsungtv_smart": [
        ...
        {"id": "ip_control", "kind": "obs_data", "field": "ip_control_token",
         ...
         "fix": "In Pro: Systems › Samsung TV › Configure → enable IP Control → Pair now, then accept the prompt on the panel"},
        {"id": "art_readback", "kind": "opt", "option": "ip_control_art_mode",
         ...
         "fix": "In Pro: Systems › Samsung TV › Configure → Show Advanced Options → turn ON Art Mode readback (ip_control_art_mode)"},
        {"id": "power_on_wol", "kind": "opt", "option": "power_on_method",
         ...
         "fix": "In Pro: Systems › Samsung TV › Configure → set Power On Method to WOL"},
        {"id": "ping_port", "kind": "opt", "option": "ping_port", "want": "set",
         ...
         "fix": "In Pro: Systems › Samsung TV › Configure → set ping_port to the discovered open port"},
        ...
        {"id": "app_enumeration", "kind": "obs_apps",
         ...
         "fix": "In Pro: tap Copy app list on this alarm, then Systems › "
                "Samsung TV › Configure → Show Advanced Options → Configure "
                "Applications → paste"},
    ],
}
