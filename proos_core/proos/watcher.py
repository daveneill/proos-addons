...
# TVs / AVRs intentionally excluded from AUTO watch (off by design):
#   samsungtv(_smart), webostv, bravia_tv, philips_js, lg_netcast, denonavr, onkyo
...
def _mk_watch(name, entity, kind, fault_after, platform):
    ...
    return {"name": name, "kind": kind, "entity": entity, "healthy_when": "available",
