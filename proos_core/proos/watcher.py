...
WATCHES = [
    {
        ...
        # The ping sensor below is the rock-steady ground truth that lets a
        # *sustained* fault be diagnosed as wedged-integration vs truly offline.
        ...
        "fault_after": 30,
        "reach": {"sensor": "binary_sensor.192_168_1_110"},
