...
def _tts_engine():
    ...
    try:
        ...
        return _tts_cache["engine"]
    _tts_cache.update({"ts": now, "engine": eng})
    return eng
...
def _assist_speak(where, reply):
    ...
    if len(msg) > _SPEAK_CAP:
        ...
        out["cut"] = True
    try:
        _client.call_service("tts", "speak", eng,
                             {"media_player_entity_id": spk, "message": msg})
