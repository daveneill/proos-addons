...
_FACTORY_WIPE = [
    ...
    # People + UI helper collections created during commissioning. Safe to drop:
    # they're regenerated on a fresh install (the owner's person by onboarding,
    # ProOS's two dashboard helpers by ensure_dashboard_helper below); anything
    # else was commissioning-time and is meant to be wiped.
    "person",
