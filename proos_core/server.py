...
# Pro's "Update Dashboard" publishes a new version; Core pushes a refresh over SSE to every
# connected dashboard, each of which reloads and ACKs the version. Pro shows the acks live.
_dash_lock = threading.Lock()
_dash_clients = {}       # device_id -> {name, version, last_seen, q: queue.Queue}
_dash_pub_version = 0
