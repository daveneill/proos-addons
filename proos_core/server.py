    ...
    def do_GET(self):
        ...
        try:
            ...
            if parts == ["handover", "status"]:
                ...
                # the QR yet. Admin-gated (installer/pro/tech/owner are all admins;
                # the homeowner is not) — status never returns the code or creds.
                u = getattr(self, "_user", None)
                if not (handover and u and u.get("is_admin")):
