...
.logo{width:76px;height:76px;border-radius:18px;margin:0 auto 22px;background:linear-gradient(135deg,#fb5c74,#d7264f);display:flex;align-items:center;justify-content:center}
.logo svg{width:42px;height:42px;fill:#fff}
  ...
  document.addEventListener('musickitloaded', async function(){
    try{
      ...
      go.onclick=async function(){
        ...
        }catch(e){ fail('Sign-in was cancelled or failed.'); }
      };
